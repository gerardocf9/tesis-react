...
const App =()=>{
    ...
    "idMotor": "51",
    "histogramaX": "/static/img/histograms/velocidad_x_"+urlParams.get('IdMotor')+".png",
    "histogramaY": "/static/img/histograms/velocidad_y_"+urlParams.get('IdMotor')+".png",
    "histogramaZ": "/static/img/histograms/velocidad_z_"+urlParams.get('IdMotor')+".png",
    "histogramaA": "/static/img/histograms/aceleracion_"+urlParams.get('IdMotor')+".png"
});
